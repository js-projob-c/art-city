...
export class Init1714063964038 implements MigrationInterface {
  name = 'Init1714063964038';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "art_city"."customer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phone" character varying NOT NULL, "email" character varying NOT NULL, "source" "art_city"."customer_source_enum" NOT NULL, "type" "art_city"."customer_type_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "art_city"."leave_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."leave" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "from" TIMESTAMP NOT NULL, "to" TIMESTAMP NOT NULL, "days" smallint NOT NULL, "status" "art_city"."leave_status_enum" NOT NULL, "reason" character varying NOT NULL, "reviewedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, "reviewerId" uuid, CONSTRAINT "REL_34e0276fce1403a75ac8662e13" UNIQUE ("reviewerId"), CONSTRAINT "PK_501f6ea368365d2a40b1660e16b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "art_city"."payroll_type_enum" AS ENUM('BASE_SALARY', 'BONUS', 'REIMBURSE')`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."payroll" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric NOT NULL, "paidAt" TIMESTAMP NOT NULL, "type" "art_city"."payroll_type_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_7a76b819506029fc535b6e002e0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "art_city"."task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "visibleTo" "art_city"."task_visibleto_enum" NOT NULL, "status" "art_city"."task_status_enum" NOT NULL, "progress" smallint NOT NULL DEFAULT '0', "completedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "projectId" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "completedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "ownerId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "art_city"."reimburse" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "amount" numeric NOT NULL, "description" character varying NOT NULL, "type" "art_city"."reimburse_type_enum" NOT NULL, "status" "art_city"."reimburse_status_enum" NOT NULL, "supportDocument" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_80e667999362114b4fdb32c9dcd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."schedule" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_1c05e42aec7371641193e180046" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."user_detail" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "monthlySalary" numeric NOT NULL, "annualLeave" smallint NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "REL_455dfebe9344ffecf1c8e8e054" UNIQUE ("userId"), CONSTRAINT "PK_673613c95633d9058a44041794d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "art_city"."user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text NOT NULL, "password" text NOT NULL, "firstName" text NOT NULL, "lastName" text NOT NULL, "role" "art_city"."user_role_enum" NOT NULL, "department" "art_city"."user_department_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."attendance" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "signInAt" TIMESTAMP NOT NULL, "signOutAt" TIMESTAMP, "workHourFrom" TIMESTAMP NOT NULL, "workHourTo" TIMESTAMP NOT NULL, "supportDocument" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."bank" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "bank" character varying NOT NULL, "account" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_7651eaf705126155142947926e8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "art_city"."external_project_status_enum" AS ENUM('PENDING', 'IN_PROGRESS', 'COMPLETED', 'ABANDONED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."external_project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "status" "art_city"."external_project_status_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "externalPartyId" uuid, CONSTRAINT "PK_1f3b37817466ad93435d8201e01" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "art_city"."purchase_status_enum" AS ENUM('PENDING', 'PAID', 'RECEIVED', 'CANCELED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."purchase" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL, "items" jsonb NOT NULL, "status" "art_city"."purchase_status_enum" NOT NULL, "amount" numeric NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "externalPartyId" uuid, CONSTRAINT "REL_a8d19b19b5892091a013caa46f" UNIQUE ("externalPartyId"), CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."external_party" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "company" character varying NOT NULL, "contactName" character varying NOT NULL, "contactRole" character varying NOT NULL, "email" character varying, "phone" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "purchasesId" uuid, "externalProjectsId" uuid, CONSTRAINT "PK_8a6437722a7c4a0e09d2dcffdfb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "art_city"."shift_application_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."shift_application" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "fromDate" TIMESTAMP NOT NULL, "toDate" TIMESTAMP NOT NULL, "days" smallint NOT NULL, "reason" character varying, "status" "art_city"."shift_application_status_enum" NOT NULL, "reviewedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, "reviewerId" uuid, CONSTRAINT "REL_cf04167a80324a279324f463f2" UNIQUE ("reviewerId"), CONSTRAINT "PK_3f52a7665723c10c8d62257032c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "art_city"."system" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workHourFrom" TIME NOT NULL, "workHourTo" TIME NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_6b1e6b6f88da9888fde62379945" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "art_city"."leave" ADD CONSTRAINT "FK_9fb20081bf48840a16e0d33d14e" FOREIGN KEY ("userId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."leave" ADD CONSTRAINT "FK_34e0276fce1403a75ac8662e132" FOREIGN KEY ("reviewerId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."payroll" ADD CONSTRAINT "FK_542f3c5e009e4502f7c308f33c7" FOREIGN KEY ("userId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."task" ADD CONSTRAINT "FK_3797a20ef5553ae87af126bc2fe" FOREIGN KEY ("projectId") REFERENCES "art_city"."project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."project" ADD CONSTRAINT "FK_9884b2ee80eb70b7db4f12e8aed" FOREIGN KEY ("ownerId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "art_city"."user_detail" ADD CONSTRAINT "FK_455dfebe9344ffecf1c8e8e054d" FOREIGN KEY ("userId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."attendance" ADD CONSTRAINT "FK_466e85b813d871bfb693f443528" FOREIGN KEY ("userId") REFERENCES "art_city"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "art_city"."external_project" ADD CONSTRAINT "FK_d9d5c67bbc0e22f4c2e54e1e316" FOREIGN KEY ("externalPartyId") REFERENCES "art_city"."external_party"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "art_city"."user_customer" ADD CONSTRAINT "FK_f6567e22a0157abd94a877140f6" FOREIGN KEY ("customerId") REFERENCES "art_city"."customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "art_city"."user_task" ADD CONSTRAINT "FK_be3c9f1acbe21e0070039b5cf79" FOREIGN KEY ("taskId") REFERENCES "art_city"."task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
