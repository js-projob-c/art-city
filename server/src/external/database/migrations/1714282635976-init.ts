...
export class Init1714282635976 implements MigrationInterface {
    name = 'Init1714282635976'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "art_city"."user_task" ADD CONSTRAINT "FK_be3c9f1acbe21e0070039b5cf79" FOREIGN KEY ("taskId") REFERENCES "art_city"."task"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
